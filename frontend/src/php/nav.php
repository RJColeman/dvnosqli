...
<div class="topnav" id="myTopnav">
  <a href="/app/"<?= $class_attr['home'] ?>>Home</a>
  <a href="/app/?db=neo4j"<?= $class_attr['neo4j'] ?>>neo4j</a>
  <a href="/app/?db=mongodb"<?= $class_attr['mongodb'] ?>>mongodb</a>
  <a href="/app/?db=redis"<?= $class_attr['redis'] ?>>redis</a>
